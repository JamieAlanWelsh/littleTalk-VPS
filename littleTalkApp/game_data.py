GAME_DESCRIPTIONS = {
        ...
        'categorisation': {
            ...
            'learninglevel1': "We recommend starting with the easiest level first. As the child you're working with gets better at grouping and identifying items, you can increase the difficulty step-by-step. Feel free to step down a level if things feel too complex.",
            'learninglevel2': "",
